    ...
    public static void main(String[] args) throws IOException {
        try {
            ...
            servidor.createContext("/", exchange -> {
                ...
                try {
                    // Breno: Melhorado caminho dos arquivos para usar diretório de trabalho atual
                    String diretorioBase = System.getProperty("user.dir");
                    Path arquivo = Paths.get(diretorioBase, "src", "view", caminho.substring(1));
                    
                    // Breno: Adicionado fallback para caminho relativo caso o absoluto não funcione
